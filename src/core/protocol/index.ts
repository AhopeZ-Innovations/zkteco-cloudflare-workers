...
export const REQUEST_DATA = {
  DISABLE_DEVICE: new Uint8Array([0, 0, 0, 0]),
  GET_REAL_TIME_EVENT: new Uint8Array([0x01, 0x00, 0x00, 0x00]),
  GET_ATTENDANCE_LOGS: new Uint8Array([0x01, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]),
  GET_USERS: new Uint8Array([0x01, 0x09, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]),
} as const;
